...
{
    void *buffer = (void*)ioData->mBuffers[0].mData;
              ...
              andSampleRate:(UInt32)rate
{
    ...
    defaultOutputDescription.componentSubType = kAudioUnitSubType_RemoteIO; // kAudioUnitSubType_DefaultOutput
