...
{
    ddlog(core, 2, "apps_debugger_init: %s\n", core->openFilename);
...
//    static int key = 0;
    ...
    apps_debugger_printat(core, 8, 40, RGB565(0xFF, 0x00, 0x00), "  A:");
    apps_debugger_printat(core, 32, 40, RGB565(0xFF, 0x00, 0x00), "#%02x", z80.AF.b.h);
    apps_debugger_printat(core, 8, 48, RGB565(0xFF, 0x00, 0x00), "  B:");
    apps_debugger_printat(core, 32, 48, RGB565(0xFF, 0x00, 0x00), "#%02x", z80.BC.b.h);

    apps_debugger_printat(core, 8, 80, RGB565(0xFF, 0x00, 0x00), " SP:");
    apps_debugger_printat(core, 32, 80, RGB565(0xFF, 0x00, 0x00), "#%04x", z80.SP.w.l);

    apps_debugger_printat(core, 8, 88, RGB565(0xFF, 0x00, 0x00), " PC:");
    apps_debugger_printat(core, 32, 88, RGB565(0xFF, 0x00, 0x00), "#%04x", z80.PC.w.l);
