...
// D�finition du module        !CONFIG!=/V4!CPU Z80!
/******************************************************************************/
...
*
* R�sultat    : La valeur de l'octet a l'adresse d�sir�e
*
...
*
* R�sultat    : La valeur du mot a l'adresse d�sir�e
*
* Variables globales modifi�es : /
*
********************************************************** !0! ****************/
...
static int ED_FF(core_crocods_t *core)   /* Breakpoint */
{
    printf("Breakpoint");
    return(2);
}
...
static int DD_FD(core_crocods_t *core)   /* special DD_FD */
{
    ...
    return(1 + tabIY[ PEEK8(core, RegPC++) ](core) );    // ### A v�rifier
}
...
static int FD_DD(core_crocods_t *core)   /* special FD_DD */
{
    ...
    RegR = (UBYTE)( ( (RegR + 1) & 0x7F) | (UBYTE)(RegR & 0x80) );
    return(1 + tabIX[ PEEK8(core, RegPC++) ](core) );    // ### A v�rifier
}
