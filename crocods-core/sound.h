...
#define SNDBUFSIZE (1024 * 4)

typedef enum {
    CROCODS_AUDIO_S16LSB,
    CROCODS_AUDIO_S16MSB,
    CROCODS_AUDIO_F32LSB
} CPC_AUDIOFORMAT;
...
void disableSound(core_crocods_t *gb);
void enableSound(core_crocods_t *gb);
