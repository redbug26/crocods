...
* R�sultat    : /
*
* Variables globales modifi�es : RegsCRTC, CRTC_Reg, XStart, XEnd
*
********************************************************** !0! ****************/
...
*
* R�sultat    : La ligne suivante du CRTC � afficher
*
...
void VGA_Update(core_crocods_t *core)
{
    ...
    if (!core->SyncCount) {
        //
        // Si 52 lignes compt�e -> G�n�ration d'une interruption
        //
        if (core->CntHSync == 52) {
            core->CntHSync = 0;
