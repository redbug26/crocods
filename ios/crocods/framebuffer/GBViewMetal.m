...
//    height = 272;
    ...
    CGRect frame = CGRectMake(0, 0, self.frame.size.width, (self.frame.size.width * 240.0) / 320.0);

    MTKView *view = [[MTKView alloc] initWithFrame:frame device:(device = MTLCreateSystemDefaultDevice())];
    view.delegate = self;
