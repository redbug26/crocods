#define COLOR_LOW             1.2
#define COLOR_HIGH            1.5
#define VERTICAL_BORDER_DEPTH 0.6
#define SCANLINE_DEPTH        0.7
#define CURVENESS             0.0

//#define CURVENESS             0.15
STATIC vec4 scale(sampler2D image, vec2 position, vec2 input_resolution, vec2 output_resolution)
{
    /* Curve and pixel ratio */
    float y_curve = cos(position.x - 0.5) * CURVENESS + (1 - CURVENESS);
    float y_multiplier =  8.0 / 8.0 / y_curve;
    ...
    float x_multiplier = 8.0 / 8.0 / x_curve;
...
//    if ((int(position.x * input_resolution.x * 4) & 3) == 1) {
//        center.g = 0;
//        right.g = 0;
//        left.g = 0;
//        center.b = 0;
...
//        left.b = 0;
//    }
//    if ((int(position.x * input_resolution.x * 4) & 3) == 2) {
//        center.r = 0;
//        right.r = 0;
//        left.r = 0;
//        center.b = 0;
...
//        left.b = 0;
//    }
//    if ((int(position.x * input_resolution.x * 4) & 3) == 3) {
//        center.r = 0;
//        right.r = 0;
//        left.r = 0;
//        center.g = 0;
